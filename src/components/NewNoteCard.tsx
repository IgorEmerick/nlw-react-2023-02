...
export function NewNoteCard({ onCreateNote }: INewNoteCardProps) {
  ...
  return (
    <Root>
      <Trigger className='rounded-md bg-slate-700 p-5 gap-3 flex flex-col text-left hover:ring-2 hover:ring-slate-600 focus-visible:ring-2 focus-visible:ring-lime-400 outline-none'>
